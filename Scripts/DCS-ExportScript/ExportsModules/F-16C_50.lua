...
--Need update to correct path.
dofile(lfs.writedir() .. [[Scripts\DCS-ExportScript\ExportsModules\F-16C_50_DED.lua]])
...
function ExportScript.ProcessIkarusDCSConfigLowImportance(mainPanelDevice)
	...
	local li = ExportScript.Tools.getListIndicatorValue(6) -- 6 for DED

	if ExportScript.Config.Debug then
		ExportScript.Tools.WriteToLog('DED: '..ExportScript.Tools.dump(li))
	end

	if li ~=nil then

		local DEDLine1 = buildDEDLine_li(li, 1);
		local DEDLine2 = buildDEDLine_li(li, 2);
		local DEDLine3 = buildDEDLine_li(li, 3);
		local DEDLine4 = buildDEDLine_li(li, 4);
		local DEDLine5 = buildDEDLine_li(li, 5);

		ExportScript.Tools.SendData("DEDL1", string.format("%s", DEDLine1["dat"]):gsub(":", "!"))
		ExportScript.Tools.SendData("DEDL1I", string.format("%s", DEDLine1["inv"]):gsub(":", "!"))
		ExportScript.Tools.SendData("DEDL2", string.format("%s", DEDLine2["dat"]):gsub(":", "!"))
		ExportScript.Tools.SendData("DEDL2I", string.format("%s", DEDLine2["inv"]):gsub(":", "!"))
		ExportScript.Tools.SendData("DEDL3", string.format("%s", DEDLine3["dat"]):gsub(":", "!"))
		ExportScript.Tools.SendData("DEDL3I", string.format("%s", DEDLine3["inv"]):gsub(":", "!"))
		ExportScript.Tools.SendData("DEDL4", string.format("%s", DEDLine4["dat"]):gsub(":", "!"))
		ExportScript.Tools.SendData("DEDL4I", string.format("%s", DEDLine4["inv"]):gsub(":", "!"))
		ExportScript.Tools.SendData("DEDL5", string.format("%s", DEDLine5["dat"]):gsub(":", "!"))
